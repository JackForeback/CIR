...
#SBATCH --time=5:00:00
#SBATCH --job-name=cir-altvae
#SBATCH --output=slurm-%j.out
#SBATCH --error=slurm-%j.err
##SBATCH --mail-type=end,fail
#
# Submit with: sbatch scripts/slurm_altvae.sh
#
# Set CIR_VENV to your environment before submitting, e.g.
#   CIR_VENV=/mnt/projects/debruinz_project/pytorch-nightly-env sbatch scripts/slurm_altvae.sh
set -euo pipefail
