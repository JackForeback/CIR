...
#SBATCH --time=5:00:00
#SBATCH --job-name=cir-alvae
#SBATCH --output=slurm-%j.out
#SBATCH --error=slurm-%j.err
##SBATCH --mail-type=end,fail
#
# Submit with: sbatch scripts/slurm_alvae.sh
#
# Set CIR_VENV to your environment before submitting, e.g.
#   CIR_VENV=/mnt/projects/debruinz_project/pytorch-nightly-env sbatch scripts/slurm_alvae.sh
set -euo pipefail
